 ...
 * @since  1.6
 */
class EckohModelLevel2pluss extends JModelList
{
...
/**
	...
	*/
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__eckohproducts_level2plus` AS a');
