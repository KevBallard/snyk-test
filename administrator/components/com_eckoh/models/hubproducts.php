 ...
 * @since  1.6
 */
class EckohModelHubproducts extends JModelList
{
...
/**
	...
	*/
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				...
				'topfeatureboxes', 'a.`topfeatureboxes`',
				'featurearea', 'a.`featurearea`',
				'featureimage', 'a.`featureimage`',
				'middlefeatureboxes', 'a.`middlefeatureboxes`',
				'calltoactiontext', 'a.`calltoactiontext`',
				'calltoactionbutton', 'a.`calltoactionbutton`',
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__eckoh_hubproduct` AS a');
