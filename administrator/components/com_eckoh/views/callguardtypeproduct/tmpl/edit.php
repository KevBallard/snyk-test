...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'callguardtypeproduct.cancel') {
			Joomla.submitform(task, document.getElementById('callguardtypeproduct-form'));
		}
		else {
			
			if (task != 'callguardtypeproduct.cancel' && document.formvalidator.isValid(document.id('callguardtypeproduct-form'))) {
...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="callguardtypeproduct-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_ECKOH_TITLE_CALLGUARDTYPEPRODUCT', true)); ?>
		<div class="row-fluid">
			<div class="span10 form-horizontal">
				...
				<?php echo $this->form->renderField('minicalltoactionbutton'); ?>
				...
				<?php echo $this->form->renderField('casestudylogo'); ?>
				<?php echo $this->form->renderField('Feature area 2'); ?>
				<?php echo $this->form->renderField('Feature image 2'); ?>
