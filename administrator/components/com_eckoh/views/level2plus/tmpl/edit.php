...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'level2plus.cancel') {
			Joomla.submitform(task, document.getElementById('level2plus-form'));
		}
		else {
			
			if (task != 'level2plus.cancel' && document.formvalidator.isValid(document.id('level2plus-form'))) {
...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="level2plus-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_ECKOH_TITLE_LEVEL2PLUS', true)); ?>
		<div class="row-fluid">
			<div class="span10 form-horizontal">
				...
				<?php echo $this->form->renderField('topfeatures'); ?>
