...
/**
 * View class for a list of Eckohpages.
 *
 * @since  1.6
 */
class EckohpagesViewProducts extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		EckohpagesHelper::addSubmenu('products');
	...
	protected function addToolbar()
	{
		...
		$canDo = EckohpagesHelper::getActions();

		JToolBarHelper::title(Text::_('COM_ECKOHPAGES_TITLE_PRODUCTS'), 'products.png');
		...
		{
			JToolBarHelper::preferences('com_eckohpages');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_eckohpages&view=products');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`productname`' => JText::_('COM_ECKOHPAGES_PRODUCTS_PRODUCTNAME'),
			'a.`visibleproductname`' => JText::_('COM_ECKOHPAGES_PRODUCTS_VISIBLEPRODUCTNAME'),
