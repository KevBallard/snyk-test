...
//
$eckohNewsItems = "SELECT * FROM PageSearchIndex WHERE cPath LIKE '/investor-news%' ORDER BY cID ASC";
...
$newsSlug = strtolower(str_replace("&", "and" , $newsSlug));
	...
	VALUES('5', 'article', '" . addslashes($newsNameFiltered) . "', '" . addslashes($newsSlug) . "', '" . $newsCreatedDate . "', '" . $newsModifiedDate . "', 676, '" . $newsCreatedDate . "', '0000-00-00 00:00:00' , '0' , '0', '1', '1', '676', ' ', '1', '" . $newsFullElement . "', '" . $params . "')";
...
//UPDATE THE CATEGORY ID TABLE SET THE WHERE ID TO THE BLOGID PLUS ONE 
	$getNewsIds = 'SELECT id FROM tnvr0_zoo_item WHERE id >= 573';
