...
//
$eckohNewsItems = "SELECT * FROM newUSnewsimport WHERE cPath LIKE '/resources/news-press%'ORDER BY id ASC";
...
$newsSlug = strtolower(str_replace("&", "and" , $newsSlug));
	...
	VALUES('13', 'article', '" . addslashes($newsNameFiltered) . "', '" . addslashes($newsSlug) . "', '" . $newsCreatedDate . "', '" . $newsModifiedDate . "', 676, '" . $newsCreatedDate . "', '0000-00-00 00:00:00' , '0' , '0', '1', '1', '676', ' ', '1', '" . $newsFullElement . "', '" . $params . "')";
...
//UPDATE THE CATEGORY ID TABLE SET THE WHERE ID TO THE BLOGID PLUS ONE 
	$getNewsIds = 'SELECT id FROM tnvr0_zoo_item WHERE id >= 1019';
