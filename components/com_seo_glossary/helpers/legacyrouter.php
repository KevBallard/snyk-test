 ...
 * @since  1.6
 */
class Seo_glossaryRulesLegacy implements RulesInterface
{
    /**
    ...
    public function build(&$query, &$segments)
    {
        ...
        if (isset($query['id']))
        {
            ...
            if ($view !== null)
            {
				...
				if ($view == 'glossaryterm')
				{
					$model      = Seo_glossaryHelpersSeo_glossary::getModel($view);
				...
				if ($view == 'glossaryterms')
				{
					$segments[] = $query['id'];
				}
				// if ($view == 'glossarytermform')
				// {
				// 	$segments[] = $query['id'];
				// }
            }
    ...
    public function parse(&$segments, &$vars)
    {
        ...
        $vars['view'] = 'glossaryterm';
        $model        = Seo_glossaryHelpersSeo_glossary::getModel($vars['view']);
